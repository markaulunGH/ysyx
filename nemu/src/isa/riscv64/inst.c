...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000000 ????? ????? 101 ????? 00110 11", srliw  , I, R(dest) = SEXT(BITS(src1 >> BITS(imm, 4, 0), 31, 0), 32));
  INSTPAT("0100000 ????? ????? 101 ????? 00110 11", sraiw  , I, R(dest) = SEXT(BITS((sword_t) src1 >> BITS(imm, 4, 0), 31, 0), 32));
  ...
  INSTPAT("0100000 ????? ????? 101 ????? 01110 11", sraw   , R, R(dest) = SEXT(BITS((sword_t) src1 >> BITS(src2, 4, 0), 31, 0), 32));

  INSTPAT("0000001 ????? ????? 000 ????? 01100 11", mul    , R, R(dest) = (__uint128_t) src1 * (__uint128_t) src2);

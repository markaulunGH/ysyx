...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0100000 ????? ????? 000 ????? 01110 11", subw   , R, R(dest) = BITS(src1 - src2, 31, 0));
  INSTPAT("0000000 ????? ????? 001 ????? 01110 11", sllw   , R, R(dest) = BITS(src1 << BITS(src2, 4, 0), 31, 0));
  INSTPAT("0000000 ????? ????? 101 ????? 01110 11", srlw   , R, R(dest) = BITS(BITS(src1, 31, 0) >> BITS(src2, 4, 0), 31, 0));
  INSTPAT("0100000 ????? ????? 101 ????? 01110 11", sraw   , R, R(dest) = BITS((int32_t) BITS(src1, 31, 0) >> BITS(src2, 4, 0), 31, 0));

...
const void (*ref_difftest_memcpy)(paddr_t addr, void *buf, size_t n, bool direction) = NULL;
const void (*ref_difftest_regcpy)(void *dut, bool direction) = NULL;
const void (*ref_difftest_exec)(uint64_t n) = NULL;
const void (*ref_difftest_raise_intr)(word_t NO) = NULL;
...
void init_difftest(char *ref_so_file, int img_size)
{
    ...
    const void (*ref_difftest_init)() = dlsym(handle, "difftest_init");

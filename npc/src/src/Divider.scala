...
class Divider extends Base_Divider
{
    ...
    {
        x := Cat(0.U(64.W), Mux(io.bits.sign && in.bits.dividend(63), ~in.bits.dividend + 1.U(64.W), in.bits.dividend))
        y := Cat(0.U(64.W), Mux(io.bits.sign && in.bits.divisor(63), ~in.bits.divisor + 1.U(64.W), in.bits.divisor))
